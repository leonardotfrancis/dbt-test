...
{{ config(materialized='incremental'
         ...
         ,primary_key=["date_start", "account_id", "campaign_id", "publisher_platform", "platform_position", "impression_device" ]
         ,cluster_by=["date_start","campaign_id"]
    )
}}


WITH facebook_ads_campaign AS (
...
SELECT  day 
        ...
        ,MAX(buying_type)                                                               AS buying_types
